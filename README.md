...
14. Double click on theS the MCU part to open settings. Next to the Program File option, give full path to the Hex file generated using STM32Cube IDE. Then set the external crystal frequency to 8M (i.e. 8 MHz). Click OK to save the changes.
...
## Proteus layout(Add pdf screen shot of circuit here)
 ...
 ![alt text](<Screenshot 2024-04-18 113522.png>)
